...
gitem_armor_t jacketarmor_info	= { 0,  50, .30, .00, ARMOR_JACKET}; //changed armor values all to 0, no armor for them!
gitem_armor_t combatarmor_info	= { 0, 100, .60, .30, ARMOR_COMBAT};
gitem_armor_t bodyarmor_info	= {0, 200, .80, .60, ARMOR_BODY};
